$(document).ready(function() {
  ...
  const MODAL_STATE = {
    block(){  document.querySelector('.modal').style.display = "block"},
    none(){ document.querySelector('.modal').style.display = "none"},
    scrollHidden(){  document.body.style.overflow = "hidden"},
    scrollVisible(){  document.body.style.overflow = "visible"}
 ...
 function Modal(){
  ...
  document.querySelectorAll('.btn')[0].addEventListener('click',()=>{
    ...
    IMG.setAttribute('src', `https://pbs.twimg.com/profile_images/1843440492/images__1__400x400.jpg`)
